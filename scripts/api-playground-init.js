...
/**
 * This script will mass generate all the docs for the Navify Framework components.
...
(async function () {
  const response = await fetch('https://unpkg.com/@navify/docs/core.json');
...
function renderFrontmatter({ tag }) {
  ...
  if (fs.existsSync(path.join(DEMOS_PATH, demoPath))) {
    ...
    frontmatter.demoSourceUrl = `https://github.com/navify/navify-docs/tree/main/static/demos/${demoPath}`;
  }
