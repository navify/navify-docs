      ...
      <pre className={styles.codePre}>
        <code ref={codeRef}>
          ...
          {Object.entries(colors).map(([name, color], i) => (
            <>
              {'\t'}--nav-color-{name}: {color.value};{'\n'}
              {'\t'}--nav-color-{name}-rgb: {color.valueRgb};{'\n'}
              {'\t'}--nav-color-{name}-contrast: {color.contrast};{'\n'}
              {'\t'}--nav-color-{name}-contrast-rgb: {color.contrastRgb};{'\n'}
              {'\t'}--nav-color-{name}-shade: {color.shade};{'\n'}
              {'\t'}--nav-color-{name}-tint: {color.tint};{'\n'}
              {'\n'}
            </>
          ))}
          {'}'}
