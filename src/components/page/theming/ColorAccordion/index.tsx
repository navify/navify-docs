...
export default function ColorAccordion({ ...props }) {
  ...
  const getColors = useCallback(
    (color) => ({
      baseColor: getComputedStyle(el.current).getPropertyValue(`--nav-color-${color}`),
      shadeColor: getComputedStyle(el.current).getPropertyValue(`--nav-color-${color}-shade`),
      tintColor: getComputedStyle(el.current).getPropertyValue(`--nav-color-${color}-tint`),
    }),
    []
  );
      ...
      {colors.map((color) => {
        ...
        return (
          <li
            ...
            style={
              {
                'background-color': `var(--nav-color-${color})`,
                color: `var(--nav-color-${color}-contrast)`,
              } as any
            }
          >
            ...
            <ul className={styles.colorSubmenu}>
              <li
                ...
                style={
                  {
                    'background-color': `var(--nav-color-${color}-shade)`,
                    color: `var(--nav-color-${color}-contrast)`,
                  } as any
                }
              >
              ...
              <li
                ...
                style={
                  {
                    'background-color': `var(--nav-color-${color}-tint)`,
                    color: `var(--nav-color-${color}-contrast)`,
                  } as any
                }
              >
