...
import { EditorOptions, openHtmlEditor, openReactEditor, openKduEditor } from './stackblitz.utils';
...
import { IconHtml, IconTs, IconKdu, IconDefault, IconCss, IconDots } from './icons';
...
export default function Playground({
  ...
  const [navifyMode, setNavifyMode] = useState(defaultMode);
  ...
  const isIOS = navifyMode === Mode.iOS;
  const isMD = navifyMode === Mode.MD;

  const sourceiOS = useBaseUrl(`${src}?navify:mode=${Mode.iOS}`);
  const sourceMD = useBaseUrl(`${src}?navify:mode=${Mode.MD}`);
  ...
  function openEditor(event) {
    ...
    switch (usageTarget) {
      ...
      case UsageTarget.React:
        ...
        break;
      case UsageTarget.Kdu:
        openKduEditor(codeBlock, editorOptions);
        break;
    }
  }
        ...
        <div className="playground__control-toolbar">
          ...
          <div className="playground__control-group">
            <ControlButton
              ...
              isSelected={isIOS}
              handleClick={() => setNavifyMode(Mode.iOS)}
              title="iOS mode"
              label="iOS"
            />
            <ControlButton
              ...
              isSelected={isMD}
              handleClick={() => setNavifyMode(Mode.MD)}
              title="MD mode"
              label="MD"
            />
          </div>
          <div className="playground__control-group playground__control-group--end">
            ...
            <Tippy theme="playground" arrow={false} placement="bottom" content="Report an issue">
              <a
                ...
                href="https://github.com/navify/navify-docs/issues/new/choose"
