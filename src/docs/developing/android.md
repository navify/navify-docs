---
title: Android App Development Guide
outline: deep
---
...
<img src="/img/installation/android-emulator-booting.png" style="display: block;margin: 0 auto;width: 200px;" />
...
```sh
navify jigra run android -l --host=YOUR_IP_ADDRESS
```
