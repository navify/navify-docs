...
import { NavContent, NavHeader, NavToolbar, NavTitle, NavList, NavItem, NavButtons, NavButton } from '@navify/react';
    ...
    <>
      <NavHeader translucent={true}>
        <NavToolbar>
          ...
          <NavButtons collapse={true} slot="end">
      ...
      <NavContent fullscreen={true}>
        ...
        <div className="nav-padding">Scroll the list to see the title & buttons collapse.</div>
