...
<script lang="ts">
  import { NavButton, NavItem, NavLabel, NavList, NavListHeader } from '@navify/kdu';
  import { defineComponent } from 'kdu';

  export default defineComponent({
    components: { NavButton, NavItem, NavLabel, NavList, NavListHeader },
  });
</script>
```
