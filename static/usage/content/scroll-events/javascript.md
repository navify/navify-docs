...
<script>
  ...
  content.addEventListener('navScrollStart', () => console.log('scroll start'));
  content.addEventListener('navScroll', (ev) => console.log('scroll', ev.detail));
  content.addEventListener('navScrollEnd', () => console.log('scroll end'));
</script>
```
