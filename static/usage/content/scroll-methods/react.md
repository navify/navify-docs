...
function Example() {
  const contentRef = createRef<HTMLNavContentElement>();
  ...
  return (
    <NavContent ref={contentRef} className="nav-padding">
      <h1>Click on the buttons to scroll the content.</h1>

      <NavButton expand="block" onClick={scrollToBottom}>Scroll to Bottom</NavButton>
      ...
      <NavButton expand="block" onClick={scrollToTop}>Scroll to Top</NavButton>
    </NavContent>
  );
}
