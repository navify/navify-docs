```html
<template>
  <nav-content ref="content" class="nav-padding">
    <h1>Click on the buttons to scroll the content.</h1>

    <nav-button expand="block" @click="scrollToBottom()">Scroll to Bottom</nav-button>
    ...
    <nav-button expand="block" @click="scrollToTop()">Scroll to Top</nav-button>
  </nav-content>
</template>
