...
<template>
  ...
  <nav-content :fullscreen="true" class="nav-padding">
...
<script lang="ts">
  import { NavContent, NavFooter, NavHeader, NavTitle, NavToolbar } from '@navify/kdu';
  import { defineComponent } from 'kdu';

  export default defineComponent({
    components: { NavContent, NavFooter, NavHeader, NavTitle, NavToolbar },
  });
</script>
