...
<head>
  ...
  <meta name="description" content="nav-skeleton-text is a component for rendering placeholder content. The element will render a gray block at the specified width as a loading text framework." />
</head>
