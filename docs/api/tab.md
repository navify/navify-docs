...
<head>
  <title>nav-tab - Navify Framework Application Component</title>
  <meta name="description" content="nav-tab is a child component of tabs. Each nav-tab can contain a top level navigation stack for an application or a single view. Read to learn more." />
</head>
