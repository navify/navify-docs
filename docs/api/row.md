...
<head>
  <title>nav-row: Horizontal Row Components and Alignment | Navify API Docs</title>
  <meta name="description" content="Rows are horizontal components of the grid system and contain varying numbers of columns. Read our nav-row API Docs for more information on alignment and usage." />
</head>
