...
<head>
  <title>nav-card: Card UI Components for Navify Framework API</title>
  <meta name="description" content="nav-card UI components are entry points to more detailed information. Cards can be single components or made up of some header, title, subtitle, and content." />
</head>
