...
<head>
  <title>nav-chip:  Name, Text, Icon and Avatar for Navify Framework Apps</title>
  <meta name="description" content="nav-chips represent complex entities in small blocks, such as a contact. A chip can contain several different elements such as names, avatars, text, and icons." />
</head>
