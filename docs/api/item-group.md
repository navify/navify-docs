...
<head>
  <title>nav-item-group: Group Items to Divide into Multiple Sections</title>
  <meta name="description" content="Item groups are containers that organize similar items together. nav-item-groups can contain item dividers to divide the items into multiple sections. " />
</head>
