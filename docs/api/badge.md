...
<head>
  <title>Badges | nav-badge: iOS & Android App Notification Badge Icons</title>
  <meta name="description" content="Badges are inline block elements that appear near other elements on iOS & Android apps—use nav-badges as notifications that indicate how many items there are." />
</head>
