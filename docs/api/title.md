...
<head>
  <title>nav-title: Navify Framework App Title Component for Toolbars</title>
  <meta name="description" content="nav-title is a component that sets the title of the toolbar. Read to learn more about title and collapsible title components and usage for Navify Framework Apps." />
</head>
