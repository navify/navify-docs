...
<head>
  <title>nav-fab: Floating Action Button for Android and iOS Navify Apps</title>
  <meta name="description" content="Fabs, floating action buttons, are container elements that contain one or more fab buttons. Use nav-fab when creating Android and iOS apps with Navify Framework." />
</head>
