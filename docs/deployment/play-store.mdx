...
<head>
  <title>Android Play Store Deployment: Publish Your Navify Apps</title>
  <meta
    name="description"
    content="Navify documentation for Android Play Store app deployment. Read about how to generate a release build and publish your Navify apps to the Google Play Store."
  />
</head>

If you are using Jigra, you can additionally refer to the Jigra documentation for [Deploying to Google Play](https://jigrajs.web.app/docs/android/deploying-to-google-play).

## Generating a release build of an app

<Tabs groupId="runtime">
<TabItem value="jigra" label="Jigra" default>
...
```shell
navify cordova build android --prod --release
```
...
A Navify app will have preset default values in this file but this can be changed to customize builds.
