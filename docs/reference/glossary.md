...
<head>
  <title>API Glossary: Terminology and Definitions | Navify Framework</title>
  <meta
    name="description"
    content="Navify is the platform for web developers. View our API Glossary for app-building terminology and keyword definitions to better understand Navify's capabilities."
  />
</head>
...
<section id="jigra">
  ...
  <p>
    <a href="https://jigrajs.web.app/" target="_blank">
      Jigra
    </a>{' '}
    ...
    beyond the traditional Hybrid app mentality. Jigra was created and is actively developed/supported by Navify, the
    company.
  </p>
</section>
...
<section id="cli">
  ...
  <p>
    ...
    use Command Prompt. The Navify community often uses this term to refer to{' '}
    <a href="https://navifyframework.web.app/docs/v1/cli/">Navify's CLI</a>.
  </p>
</section>
...
<section id="navicons">
  ...
  <p>
    <a href="https://navify.web.app/navicons/" target="_blank">
      Navicons
    </a>{' '}
    is an open-source icon set used and created by Navify. It includes 1:1 iOS and Material Design icons, as well as
    commonly used social/application icons. Navicons is included by default in Navify distributions, but they can also be
    used in any project.
  </p>
</section>
...
<section id="node">
  ...
  <p>
    ...
    services, node is often used to build developer tools, such as the <a href="#cli">Navify CLI</a>.
  </p>
</section>
...
<section id="npm">
  ...
  <p>
    ...
    modules. Navify can be installed with npm, along with a number of its dependencies.
  </p>
</section>
...
<section id="sass">
  ...
  <p>
    Sass is a stylesheet language that compiles to CSS and is used by Navify. Sass is like CSS, but with extra features
    such as{' '}
...
<section id="transpiler">
  ...
  <p>
    ...
    <em>transpilation</em> in Navify Framework is converting <a href="#es2015-es6">ES2015/ES6</a> (
...
<section id="typescript">
  ...
  <p>
    ...
    . Although Navify is built with TypeScript, using it to build an Navify app is completely optional.
  </p>
</section>
