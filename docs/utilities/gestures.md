...
<head>
  <title>Gestures | Navify App Utility for Custom Gestures and Interactions</title>
  <meta
    name="description"
    content="Navify Gestures is a utility that allows developers to build custom gestures and interactions for their app in a platform agnostic manner. Read to learn more."
  />
</head>

## Overview

Navify Gestures is a utility that allows developers to build custom gestures and interactions for their application in a platform agnostic manner. Developers do not need to be using a particular framework such as React or Kdu, nor do they even need to be building a Navify app! As long as developers have access to v5.0 or greater of Navify Framework, they will have access to all of Navify Animations.
...
```javascript
import { createGesture } from 'https://cdn.jsdelivr.net/npm/@navify/core@latest/dist/esm/index.mjs';
...
```tsx
import { createGesture, Gesture } from '@navify/core';
...
Developers using React should install the latest version of `@navify/react`. Full React wrappers are coming soon!

```tsx
import { createGesture, Gesture } from '@navify/react';
...
```javascript
import { createGesture } from '@navify/kdu';
import { ref } from 'kdu';
...
<Codepen user="khanhduy1407" slug="VwByXVz" />
...
<Codepen user="khanhduy1407" slug="MWBrVZg" />

## Gesture Animations

See our guide on implementing gesture animations: [Gesture Animations with Navify Animations](animations.md#gesture-animations)
