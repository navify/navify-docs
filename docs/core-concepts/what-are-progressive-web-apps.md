...
<head>
  <title>Progressive Web Applications: What is a PWA - Navify Documentation</title>
  <meta
    name="description"
...
This can work in conjunction with [Jigra](https://jigrajs.web.app) to provide a multiple deploy targets for all your users.
You can deploy your app as a PWA as well as Native app and take advantage of both channels.

Navify allows you to ship your app to not only the app store, but also deploy to the mobile web as a PWA.
...
There is a lot here, but it boils down to a few points for Navify apps.
