...
<head>
  <title>Create an Navify React App: Framework and Documentation</title>
  <meta
    name="description"
    content="One codebase, any platform, just React. View our documentation for creating apps with Navify React—the native React version of Navify Framework's open-source SDK."
  />
</head>
...
Navify React projects are just like React projects, leveraging [react-dom](https://reactjs.org/docs/react-dom.html) and with setup normally found in a [Create React App (CRA)](https://github.com/facebook/create-react-app) app. For [routing and navigation](/docs/react/navigation), React Router is used under the hood.
...
Deploy your Navify React projects to native iOS, Android, Electron, and the web as a Progressive Web App, using [Jigra](https://jigrajs.web.app), a modern native runtime. All with one shared codebase.
...
<DocsCard header="Navigation" href="react/navigation" icon="/icons/feature-component-navigation-icon.png">
  <p>Learn the basics of navigation inside your app with Navify and React Router</p>
</DocsCard>
